import requests, netCDF4, datetime

#天気情報取得用
def weather(lat,lon):
    params={"lat":str(lat),"lon":str(lon),"units":"metric","appid":"47323be29c7adfb45789b53971bc5311"}
...
def get_sunlight_value(lat_val,lon_val):
    ...
    hhmm=hh+mm
    nc= netCDF4.Dataset('H08_'+yyyymmdd+'_'+hhmm+'_rFL010_FLDK.02701_02601.nc','r')  
